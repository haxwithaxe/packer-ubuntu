...
apt-get -y purge popularity-contest command-not-found friendly-recovery bash-completion fonts-ubuntu-* laptop-detect motd-news-config usbutils grub-legacy-ec2
